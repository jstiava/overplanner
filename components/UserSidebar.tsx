...
export default function UserSidebar() {
    ...
    const { user, events } = useContext(OverplannerSessionContext);
        ...
        <div className="flex flex-col p-1 h-full w-full flex-col bg-foreground/3">
            ...
            <div className="flex flex-col min-h-0 flex-1 p-1 gap-1">
                ...
                {events?.map(event => {
                    ...
                    return (
                        <Button key={event.id} variant={'outline'} className={'flex w-full h-8 items-center px-2 justify-start gap-2'}>
